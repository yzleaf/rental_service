		...
		<div class="col-md-6">
			...
			<form action="checkSignup.php" method="post">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="dln" name="dln" onblur="checkNull('dln','dln');">
				</div>
				<div class="form-group">
					<label for="">insurance company name</label>
					<input type="text" class="form-control" id="iname" name="iname" onblur="checkNull('iname','iname');">
				</div>
				<div class="form-group">
					<label for="">insurance policy number</label>
					<input type="text" class="form-control" id="inum" name="inum" onblur="checkNull('inum','inum');">
				</div>
				<div class="form-group">

		...
		<div class="col-md-6">
			...
			<form action="./php_operation/cust_change_check.php" method="post">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="dln" name="dln" onblur="checkNull('dln','dln');" value="<?php echo $cust_res['emp_id']?>" required=required>
				</div>
				<div class="form-group">
					<label for="">corporate registration number</label>
					<input type="text" class="form-control" id="iname" name="iname" onblur="checkNull('iname','iname');" value="<?php echo $cust_res['corp_reg_no']?>" required=required>
				</div>
				<div class="form-group">
					<label for="">corporation name</label>
					<input type="text" class="form-control" id="inum" name="inum" onblur="checkNull('inum','inum');" value="<?php echo $cust_res['corp_name']?>" required=required>
				</div>
				<div class="form-group">

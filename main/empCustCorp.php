	...
	<div class="container">
		...
		<div class="col-md-10">
			<div class="row" style="margin-bottom: 20px;">
				<a href="empCustInfo.php"><button class="col-md-4 btn btn-primary">All</button></a>
				<a href="empCustIndi.php"><button class="col-md-4 btn btn-primary">Individual Customer</button></a>
				<a href="empCustCorp.php"><button class="col-md-4 btn btn-primary active">Corporate Customer</button></a>
			</div>
			<div>
				<div class="row" style="margin-bottom: 20px;">
					<div class="col-md-4"></div>
						<a href="signupCorp.php">
							<button class="col-md-4 btn btn-primary">Add Corporate Customer</button>
						</a>	
				</div>
				<div class="row" style="margin-bottom: 20px;">
